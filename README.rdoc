...
Proc digests are now based the name of the class and the value of Proc#name (if available). Procs or objects containing Procs will have different digests than those created in previous releases.
